...
//! let domain = list.parse_dns_name("www.example.com").unwrap();
...
//! // 2-level TLD
//! let domain = list.parse_dns_name("wWw.BlUeCaTnEtWoRkS.Uk.CoM.").unwrap();
...
//! // the root name
//! let domain = list.parse_dns_name(".").unwrap();
